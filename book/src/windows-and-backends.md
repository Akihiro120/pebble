...
`WGPUPlugin` also wires up keyboard/mouse/window input — see [Input](./input.md) — and runtime control over the window itself (cursor, title, fullscreen, ...) — see [Window Control](./window-control.md).
